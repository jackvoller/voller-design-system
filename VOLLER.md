...
Icons, voller.uk and the App Store stay `#82BA51` and `#F0C21C`. Meal Planner's accent is a brighter
...
- No `#00A000`, `#111827`, `#EF4444`, `#8A8A8A` in either field, or a light label on `green`.
